# encoding: utf-8
Artist.create([
  { :name => "Cesar Duranton", :business_name => "Duranton", :address => "Mexico, DF", :phone => "5512341234", :email => "cesar.duranton@artepopular.com.mx", :remote_foto_url => "https://s3.amazonaws.com/artemexicano/artist/foto/1/cesarduranton.jpg", :latitude => 19.432661, :longitud => -99.13334, :location => "Mexico, DF", :biography => "<p>Trabajo dentro del arte popular mexicano, desde hace 15 a&ntilde;os elaboro piezas piezas tradicionales y otras de dise&ntilde;o propio en cartoner&iacute;a.</p>" },
  { :name => "Jorge Rosano", :business_name => "Papel Recortado", :address => "Tepoztlan, Morelos, Mexico", :phone => "12341234", :email => "jorge.rosano@artepopular.com.mx", :remote_foto_url => "https://s3.amazonaws.com/artemexicano/artist/foto/2/jorgerosano.jpg", :latitude => 18.9856, :longitud => -99.09978, :location => "", :biography => "<p><em>\"Las formas aparecen y yo quito lo que sobra\"</em></p>\r\n<p>Jorge Rosano</p>\r\n<p><em>\"Mi arte est&aacute; relacionado con el papel recortado de los ind&iacute;genas otom&iacute;es (&ntilde;a&ntilde;u) herederos de las culturas prehisp&aacute;nicas m&aacute;s antiguas; no con el papel picado, una t&eacute;cnica que viene de China\"</em></p>\r\n<p>Jorge Rosano</p>" }
